        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <li class="scroll-to-section"><a href="faculityRequests.php" class="active">Facuilty Requests</a></li>
            ...
            <div class="col-lg-12 align-self-center">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $query = "SELECT DISTINCT * FROM admit";
...
function approve(email)
{
    ...
    window.location.href = "approve_faculty.php?email=" + email;
}

function reject(email)
{

    window.location.href = "reject_faculty.php?email=" + email;
}
